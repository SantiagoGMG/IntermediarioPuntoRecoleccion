...
<div class="padre">
    <div class="container">
        <form class="estandar" @submit="fase1" >
            <div class="mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="red" class="bi bi-1-circle" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="gray" class="bi bi-2-circle" viewBox="0 0 16 16">
            ...
            <a href="/" class="btn btn-danger right" >Regresar</a>
